...
export default function App() {
  ...
  return (
    <div id="calculator-root" className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-emerald-100 selection:text-emerald-900 pb-12">
      ...
      <footer className="text-center py-12 text-slate-400 text-xs border-t border-slate-200 mt-20 print:border-none print:mt-10">
        <p>© 2024 VibePool-lab — Remote True Value Analysis Tool</p>
      </footer>
    </div>
  );
}
